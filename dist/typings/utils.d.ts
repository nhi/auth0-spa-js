...
export declare const parseQueryResult: (queryString: string) => any;
...
export declare const getJSON: (url: any, timeout: any, options: any, worker: any) => Promise<any>;
export declare const oauthToken: ({ baseUrl, timeout, tokenEndpoint, ...options }: TokenEndpointOptions, worker: any) => Promise<any>;
